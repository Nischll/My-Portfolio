  ...
  return (
    ...
    >
      <div className="w-full">
        ...
        <p className="anim-child text-[#5C4B45] text-base sm:text-lg max-w-2xl mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
          {projects.list.map((project, i) => (
            <article
              key={i}
              className="anim-child group flex flex-col rounded-2xl border border-[#E8DDD4] bg-[#FAF7F4] overflow-hidden shadow-sm hover:shadow-lg transition-all duration-300"
            >
