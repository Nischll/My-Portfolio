      ...
      <div className="w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {experience.jobs.map((job, i) => (
            <article
              key={i}
              className="anim-child group relative flex flex-col rounded-2xl border border-[#E8DDD4] bg-[#FAF7F4] p-6 sm:p-7 shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden"
            >
              ...
              <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2 pl-4 sm:pl-5">
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <h3 className="text-lg font-semibold text-[#3B2F2F]">{job.role}</h3>
                  </div>
